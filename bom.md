...
- No MicroSD card is required for the final build.
- Volumio is intended to boot from NVMe.
...
|---:|---|---|---|
| 1 | Volumio image | Clean Volumio install for Raspberry Pi | Flash to NVMe boot media |
